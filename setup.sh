...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Uni-store/instalasi/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Uni-store/permission/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/Uni-store/instalasi/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/Uni-store/instalasi/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
cd
    ...
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/Uni-store/instalasi/main/encrypt/encrypt" ; chmod +x /usr/bin/enc
